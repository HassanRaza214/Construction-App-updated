...
export default function CheckOutButton({ cartTotal }) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => router.push('/checkout/Checkout/') }>
        <Text style={styles.buttonText}>Confirm payment and address</Text>
      </TouchableOpacity>
    </View>
  );
}
